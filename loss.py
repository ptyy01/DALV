...
#     def forward(self, source_centroids, target_centroids, text_centroids):
#         source_centroids = F.normalize(source_centroids, dim=1)
#         target_centroids = F.normalize(target_centroids, dim=-1)
#         text_centroids = F.normalize(text_centroids, dim=-1)

#         class_num = source_centroids.shape[0]
#         I = torch.eye(class_num, device=source_centroids.device)
        
#         inputs1 = source_centroids @ text_centroids.T
#         inputs2 = target_centroids @ text_centroids.T

#         inputs1 = (inputs1 + 1) / 2
#         inputs2 = (inputs2 + 1) / 2

#         loss1 = F.pairwise_distance(inputs1, I).mean()
#         loss2 = F.pairwise_distance(inputs1, I).mean()
