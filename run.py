# python run_select_samples.py --dataset_mode AID_UCMD --log_dir logs_temp --lora_r 16 --lora_all --phase train_semi --ratio 0.1 --batch_size 32 --device cuda:1 --lr 0.0001
